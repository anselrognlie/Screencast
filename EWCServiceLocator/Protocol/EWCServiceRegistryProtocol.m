...
+ (EWCServiceRegistryProtocol *)protocol {
    if (! singleton) {
        ...
        [EWCServiceRegistryAcknowledge registerPacket:singleton];
        [EWCServiceRegistryQueryRequest registerPacket:singleton];
        [EWCServiceRegistryRegisterRequest registerPacket:singleton];
        [EWCServiceRegistryLocationResponse registerPacket:singleton];
        [EWCServiceRegistryUnregisterRequest registerPacket:singleton];
    }
    return singleton;
}
